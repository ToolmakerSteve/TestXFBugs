...
namespace TestXFUWP
{
	class VMWithQueryData : Xamarin.Forms.BindableObject
	{
		...
		//public static Xamarin.Forms.BindableProperty ItemsProperty =
		//	Xamarin.Forms.BindableProperty.Create(
		//		nameof(Items), typeof(ObservableCollection<ItemModel>), typeof(VMWithQueryData));
		//public ObservableCollection<ItemModel> Items {
		//	get => (ObservableCollection<ItemModel>)GetValue(ItemsProperty);
		...
		//private async Task QueryItemsAsyncBad()
		//{
